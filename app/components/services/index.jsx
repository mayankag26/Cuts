  ...
  return (
    <div>
      <div className=' flex services flex-row mx-3 md:mx-10 space-x-5 md:space-x-12 pt-11 md:flex-row '>
        <div className='barbershop flex space-x-2 bg-slate-100 p-4 hover:bg-slate-200' onClick={() => { console.log("barbershop clicked");props.setColor(1); } }>
          <div className='w-4'><img src='/logoofshop.png'></img></div>
          <div><button className='text-sm '>Salon Nearby</button></div></div>
        <div className='barberhome flex space-x-2  bg-slate-100  p-4  hover:bg-slate-200 ' onClick={() => { console.log("barberhome clicked"); props.setColor(0); } }>
